...
Scrivi un programma che realizzi il seguente gioco tra N giocatori umani e il computer.
 All’inizio del gioco ogni giocatore ha un uguale numero NUM di fiches. Vengono giocate alcune manches dove 
 a ogni turno ciascun giocatore effettua una puntata di una fiche e riceve dal banco casualmente una carta:
...
int main ()
{
    int ngiocatori=0,numf=0;

    printf("Inserire il numero di giocatori\n");
    scanf("%d", &ngiocatori);

    printf("Inserire il numero di fiches\n");
    scanf("%d", &numf);
